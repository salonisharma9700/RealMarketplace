  ...
  const submitHandler = async (e) => {
    ...
    try{
      ...
      if(response.status == 200){ 
        ...
        localStorage.setItem("rrole",response.data[0].role);
        localStorage.setItem("remail",response.data[0].email);
        localStorage.setItem("rname",response.data[0].name);
        localStorage.setItem("rphone",response.data[0].phone);
